...
A creature so powerful that nothing can contain its rage. Joe has a large pool of HP and can use the power of rageohol to destroy his foes.'''
	...
	dmg = [1,8]
	hitdie = [1,10]
	kwargs = {'maxium_range': 7}
	tackle = Ability('Tackle', description=None, ability_function=tackle, targeting=True, targeting_message=Message('Left-click a target tile for the fireball, or right-click to cancel.', libtcod.light_cyan), **kwargs)
	abilities = [tackle]
